...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%">
        ...
        <td style="vertical-align: top">
          <%if (ViewData["SelectionList"] != null)
            { %>
            <p>
                Below is a listing of solutions you currently have access to.  Parent groupings of solutions you have limited access to are listed in red.  Solutions you have access to already are listed in blue.
            </p>
    ...
    <%=ViewData["UserList"]%><br /><br />
    <%=ViewData["TransactionList"]%>
